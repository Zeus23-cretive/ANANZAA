...
if (!message.guild.member(kick).bannable) return message.channel.send(`Belirttiğiniz kişinin Yetkisi Benden Daha Üstün!`);
message.guild.member(kick).kick();
message.channel.send(" Başarılı, "+ kick +" İD'li kullanıcı **" + reason + "** sebebiyle sunucudan atıldı.")
